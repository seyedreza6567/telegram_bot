...
def analyze(df):
    ...
    # =====================================================
    if long_context and long_score >= 8 and long_score > short_score and difference >= 2:
    ...
    # SHORT
    # =====================================================
    if short_context and short_score >= 8 and short_score > long_score and difference >= 2:
        stop_loss = price + atr * 2.0
        tp1 = price - atr * 2.0
        tp2 = price - atr * 4.0
        return {
